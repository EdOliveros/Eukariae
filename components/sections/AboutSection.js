...
const AboutSection = () => {
  // Reveal the section once it enters the viewport
  const [ref, isVisible] = useScrollReveal();

  return (
    <div ref={ref} className={`bg-secondary dark:bg-secondary-dark py-20 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center gap-12">

          <div className="w-full md:w-1/2 order-1 md:order-2">
            <div className="relative group perspective-1000">
              <div className="shadow-2xl rounded-base overflow-hidden border-4 border-white dark:border-card-bg-dark transform rotate-2 group-hover:rotate-0 transition-transform duration-500">
                <Image
                  src={ranita}
          ...
          <div className="w-full md:w-1/2 order-2 md:order-1 text-text-base dark:text-text-base-dark">
