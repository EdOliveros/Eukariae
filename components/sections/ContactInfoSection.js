    ...
    return (
        <div className="bg-bg-base dark:bg-bg-base-dark transition-colors duration-300">
            <div className="container mx-auto px-6 py-20">
                <div className="flex flex-col lg:flex-row items-center gap-12 bg-white dark:bg-card-bg-dark p-8 lg:p-12 rounded-base shadow-lg">
                    {/* Decorative Letter */}
                    ...
                    <div className="flex-1 space-y-6">
                        <div className="text-center lg:text-left">
                            <h1 className="text-3xl md:text-4xl font-extrabold text-text-base dark:text-text-base-dark mb-2 tracking-tighter uppercase">
                    ...
                    <div className="w-full lg:w-1/3">
                        <div className="relative aspect-square overflow-hidden rounded-base shadow-2xl border-4 border-white dark:border-bg-base-dark transform -rotate-3 hover:rotate-0 transition-transform duration-500">
                            <Image
                                src={img}
                                fill
